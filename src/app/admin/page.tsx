...
<h1 className="text-center text-4xl my-5 ">Services</h1>
             <div className="grid gap-4 mb-5 md:mb-0 grid-cols-1 md:grid-cols-3 place-content-center place-items-center">   { !laoding? 
                ...
                services?.map(item=>
                       <button  onClick={()=>router.push(`services/${item._id}`)} key={item._id}  className={`cuve w-[350px] h-[350px] shadow-md transform transition duration-500 ease-in-out bg-blue-300 cursor-pointer hover:scale-105 hover:bg-blue-500 hover:text-white`}>
